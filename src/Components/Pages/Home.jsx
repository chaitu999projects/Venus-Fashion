            ...
            >
              {/* <div className="flex flex-col justify-center items-center mb-3">
                ...
                <div className="flex my-10">
                  ...
                  <Link to='/mens' className="transition-colors duration-300 cursor-pointer w-[180px] p-2 border mx-2 bg-slate-50 font-bold uppercase tracking-wider  hover:bg-black text-black hover:text-white hover:border-0 text-center">
                    Shop Mens
                  </Link>
                </div>
              </div> */}
